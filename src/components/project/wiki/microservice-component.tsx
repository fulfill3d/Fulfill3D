...
const MicroserviceComponent: React.FC<{ service: Microservice }> = ({service}) => (
    <div className="mb-10 bg-gray-100 rounded-md p-4">
        ...
        <p className="text-lg text-gray-600 mb-2"><strong>Type:</strong> {service.type}</p>
        <p className="text-lg text-gray-600 mb-4"><strong>Scalability:</strong> {service.scalability}</p>
